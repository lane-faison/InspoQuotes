...
class QuoteTableViewController: UITableViewController {
    ...
    let productId = "com.lanefaison.InspoQuotes.PremiumQuotes"
    ...
    override func viewDidLoad() {
        ...
        SKPaymentQueue.default().add(<#T##observer: SKPaymentTransactionObserver##SKPaymentTransactionObserver#>)
    }
    ...
    func paymentQueue(_ queue: SKPaymentQueue, updatedTransactions transactions: [SKPaymentTransaction]) {
        for transaction in transactions {
            if transaction.transactionState == .purchased {
                ...
                print("User transaction successful")
            } else if transaction.transactionState == .failed {
                print("User transaction failed")
            }
        }
    }
}
